...
if __name__=='__main__':
	...
	tweet=spark.read.json(
		"/Users/marcela.tanaka/datapipeline/datalake/silver/twitter_aluraonline/tweet"
	...
	tweet.coalesce(1)\
		.write\
		.json("/Users/marcela.tanaka/datapipeline/datalake/gold/twitter_insight_tweet ")
